...
public class Element implements Weightable<Element> {
    ...
    public Element(String prikaz){
        ...
        if(parts.length >= 4){
            ...
            System.out.println("Příkaz byl zadán špatně"); //JV mimo UI nepouzivat sout, ale vyjimky
        }
    }
    /**
    ...
    public void setRokObjeveni(int rokObjeveni) { //JV propagovat pres boolean/vyjimku info, ze nebylo mozne nastavit
        if(rokObjeveni==-1){
